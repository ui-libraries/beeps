    ...
    <!-- Main Narrative -->    
        ...
        <header><h2>From Earth to Interstellar Space - Legacy of <sname>Explorer I</sname></h2></header>
			...
			<article class="text-container" id="interstellar"><header><h3>Unchartered territory - <sname>Voyager 1</sname> explores interstellar space</h3></header>
				...
				<aside class="in-text"><img alt="Looping animation of a coronal mass ejection Aug. 15, 2014 from NASA" src="/files/original/753519613e0230bc9ff591e8bc5ec14b.gif"><p class="caption">Looping animation of a coronal mass ejection Aug. 15, 2014<br/>Credit: Coutresy of ESA&NASA/SOHO</p></aside>
